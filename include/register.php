...
function register() {
    ...
    <table cellpadding="0" cellspacing="0" id="tableLinksHome">
        <tr>
            <td class="show_hide_regular tdLinkHome tdLinkHome<?php echo rand(1,6);?>">
                <p class="pLinkName">MyLink.si</p>
                <p class="pLinkDomain">account</p>
                <p class="pLinkUrl">Register your new MyLink.si account.</p>
            </td>
        </tr>
    </table>
    <div class="regular">
    	<?php 
    		include "include/register_normal.php";
            register_normal();
    	?>
    </div>
    <br />
